...
export { NS, DEFAULTS, isSubagent, applyAgentOptions, applyContinuableSpec, applyCallConfig, shouldRetryWithFallback }
...
export function apply(ctx, config = {}) {
  ...
  ctx.on('agent/disposed', ({ agent }) => {
    if (agent && agent.id) fallbackAgents.delete(agent.id)
  })
